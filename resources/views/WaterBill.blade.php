...
<div class="Wbill">
    <div class="text-left">
      ...
      <br>    <br>    <br>
        ...
        <form method="post" action="/saveWbill">
            {{csrf_field()}}
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="date" class="form-control" name="Bill_Period" placeholder="Date">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="number" min="1" step="any" class="form-control" name="Meter_Number" placeholder="Number">
                </div>
            </div>
