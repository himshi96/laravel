...
<head>
    ...
    <Title>ElectricityBillTablePage</Title>
...
<div class="text-left">
    ...
    <h4 style="text-align: left; font-size: 30px">Electricity Bill Details Table</h4>

</div>
<div class="container">
    <a href="EbillAdd" class="btn btn-primary" >Add Details</a>
